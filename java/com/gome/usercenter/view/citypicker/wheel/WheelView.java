...
package com.gome.usercenter.view.citypicker.wheel;
...
import com.gome.usercenter.view.citypicker.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int[] SHADOWS_COLORS = new int[] { 0xCCFFFFFF, 0x80FFFFFF, 0x80FFFFFF };
...
//            drawCenterLine(canvas);
    ...
    private void drawCenterLine(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.gome_divider_color));
        paint.setStrokeWidth(1.0f);

        int top = (int) (getHeight()/2 - getItemHeight()/2 - getResources().getDimension(R.dimen.gome_padding_size_5dp));
        int bottom = (int) (getHeight()/2 + getItemHeight()/2 + getResources().getDimension(R.dimen.gome_padding_size_5dp));
        canvas.drawLine(PADDING, top, getWidth() - PADDING, top, paint);
        canvas.drawLine(PADDING, bottom, getWidth() - PADDING, bottom, paint);
    }
